...
@section('content')
<!-- Slider -->
<section class="section-slide" style="margin-top: 90px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="/template/images/{{\Str::slug($menu->name,'-')}}.jpg" alt="IMG-BANNER">
...
<!-- Products -->
@include('products.product_home.list_pc')
@include('products.product_home.list_laptop')
@include('products.product_home.list_cpu')
@include('products.product_home.list_screen')
@include('products.product_home.list_ram')
</section>
